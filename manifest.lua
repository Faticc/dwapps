...
{
  dir = "/home/dwapps",
  -- каталог с библиотеками внутри dir: ярлык дописывает его в
  ...
  files = {
    ...
    -- сам установщик: им же и обновляются (dwapps-update)
    { "install.lua",     "install.lua",    size = 20867, crc = "2f72ff43" },
  },
